...
public class FFGBuilder {
	private final FFGFieldsAssembler assembler = new FFGFieldsAssembler();
	 ...
	 * for POJO properties
	 */
	private final Map<String, ObservableList<Object>> fieldsValues = new HashMap<>();

	/**
	 * A list with custom editors for model properties
	 */
	private final Map<String, Node> fieldsEditors = new HashMap<>();
	...
	public void showAsDialog(Consumer<Object> consumer) {
		String dTitle = "Create new " + model.getClass().getName();
		this.showAsDialog(dTitle, consumer);
	}

	public void showAsDialog(String dTitle, Consumer<Object> consumer) {
		this.showAsDialog(dTitle, null, consumer);
	}

	public void showAsDialog(String dTitle, String dHeaderText, Consumer<Object> consumer) {
	...
	public void showAsDialog(String dTitle, String dHeaderText, String okBtnText,
	                         String cancelBtnText, Consumer<Object> consumer) {
